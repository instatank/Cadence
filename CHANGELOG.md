...
- **Tomorrow card collapses for off/rest days:** instead of a full card with title and "—" subtitle, renders one inline line `NEXT · Sun, off day` (or `rest day`). Workout days keep the full card unchanged.
